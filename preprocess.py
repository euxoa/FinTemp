...
print >>ofile, "sub;sid;year;Jan;Feb;Mar;Apr;May;Jun;Jul;Aug;Sep;Oct;Nov;Dec"
for line in ifile:
    print >>ofile, ";".join([line[0:4], line[4:12]] + [line[11+5*i:16+5*i].strip() for i in xrange(13)])
